...
void init_states(){
     //State A
         states[0].name = 'A';
	 states[0].number = 0;
	 states[0].next_state_0 = states + 3; //State D
	 states[0].next_state_1 = states + 5; //State F
	 
	 //State B
	 states[1].name = 'B';
	 states[1].number = 1;
	 states[1].next_state_0 = states + 4; //State E
	 states[1].next_state_1 = states + 1; //State B
	 
	 //State C
	 states[2].name = 'C';
	 states[2].number = 2;
	 states[2].next_state_0 = states + 6; //State G
	 states[2].next_state_1 = states + 3; //State D
	 
	 //State D
	 states[3].name = 'D';
	 states[3].number = 3;
	 states[3].next_state_0 = states + 1; //State B
	 states[3].next_state_1 = states + 6; //State G
	 
	 //State E
	 states[4].name = 'E';
	 states[4].number = 4;
	 states[4].next_state_0 = states + 2; //State C
	 states[4].next_state_1 = states + 7; //State H
 
         //State F
	 states[5].name = 'F';
	 states[5].number = 5;
	 states[5].next_state_0 = states + 0; //State A
	 states[5].next_state_1 = states + 1; //State B
	 
	 //State G
	 states[6].name = 'G';
	 states[6].number = 6;
	 states[6].next_state_0 = states + 7; //State H
	 states[6].next_state_1 = states + 0; //State A
	 
	 //State H
	 states[7].name = 'H';
	 states[7].number = 7;
	 states[7].next_state_0 = states + 5; //State F
	 states[7].next_state_1 = states + 2; //State C	 
}
void printstates(){
       int i=0;
          for(i =0; i <8; i++){
